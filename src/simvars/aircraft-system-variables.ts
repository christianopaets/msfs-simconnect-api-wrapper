...
import { Float64, Int32, SFloat64, SInt32, SString32, String32 } from "./data-types/index.js";

const GENERAL = {
  "AIRSPEED TRUE CALIBRATE": define(`Angle of True calibration scale on airspeed indicator.`, Degrees, SFloat64),
  ...
  "ELT ACTIVATED": define(`Whether or not the Emergency Locator Transmitter is active.`, Bool, Int32),
  ...
  "GPWS SYSTEM ACTIVE": define(`True if the Ground Proximity Warning System is active.`, Bool, SInt32),
  ...
  "INDUCTOR COMPASS PERCENT DEVIATION": define(`Inductor compass deviation reading.`, PercentOver100, Float64),
  ...
  "KOHLSMAN SETTING MB:index": define(`The value for the given altimeter index in millibars.`, Millibars, Float64),
  ...
  "PLANE HEADING DEGREES GYRO": define(`Heading indicator (directional gyro) indication.`, Radians, SFloat64),
  "PRESSURE ALTITUDE": define(`Standard Altitude, ie: at a 1013.25 hPa (1 atmosphere) setting.`, Meters, Float64),
  "PRESSURIZATION CABIN ALTITUDE": define(`The current altitude of the cabin pressurization.`, Feet, Float64),
  "PRESSURIZATION CABIN ALTITUDE GOAL": define(`The set altitude of the cabin pressurization.`, Feet, Float64),
  "PRESSURIZATION CABIN ALTITUDE RATE": define(
    `The rate at which cabin pressurization changes.`,
    FeetPerSecond,
    Float64,
  ),
  "PRESSURIZATION DUMP SWITCH": define(`True if the cabin pressurization dump switch is on.`, Bool, Int32),
  ...
  "STRUCTURAL DEICE SWITCH": define(`True if the aircraft structure deice switch is on.`, Bool, Int32),
  ...
  "TOW RELEASE HANDLE": define(`Position of tow release handle. 100 is fully deployed.`, PercentOver100, Float64),
  ...
  "TURN COORDINATOR BALL INV": define(`Turn coordinator ball position inverted (upside down).`, Position128, Int32),
  ...
  "WINDSHIELD DEICE SWITCH": define(`True if the aircraft windshield deice switch is on.`, Bool, Int32),
} as const;
...
const VARIOMETER = {
  ...
  "VARIOMETER NETTO": define(`Variometer rate using Netto (Total Energy - polar sinkRate).`, FeetPerSecond, Float64),
  ...
  "VARIOMETER SPEED TO FLY GLIDE RATIO": define(`The glide ratio at optimal speed to fly.`, Number, Int32),
  "VARIOMETER SWITCH": define(`True if the variometer switch is on, false if it is not.`, Bool, Int32),
  "VARIOMETER TOTAL ENERGY": define(`The variometer rate using total energy.`, FeetPerSecond, Float64),
} as const;

const WATER_BALLAST = {
  "WATER BALLAST TANK CAPACITY:index": define(`The capacity of the indexed water ballast tank.`, Pounds, Float64),
  "WATER BALLAST TANK NUMBER": define(`The number of water ballast tank available.`, Number, Int32),
  "WATER BALLAST TANK QUANTITY:index": define(`The quantity of water ballast in the indexed tank.`, Pounds, Float64),
  "WATER BALLAST VALVE": define(`True (1) if a water ballast valve is available, False (0) otherwise.`, Bool, Int32),
  "WATER BALLAST VALVE FLOW RATE": define(`The flow rate of the water ballast valve.`, GallonsPerHour, Float64),
} as const;

const LIGHTS = {
  "IS ANY INTERIOR LIGHT ON": define(`Will return true if any interior light is on or false otherwise.`, Bool, Int32),
  ...
  "LIGHT GLARESHIELD": define(`Whether or not the Light switch for the Glareshield is enabled.`, Bool, SInt32),
  ...
  "LIGHT PEDESTRAL": define(`Whether or not the Light switch for the Pedestal is enabled.`, Bool, SInt32),
...
const HYDRAULICS = {
  "HYDRAULIC PRESSURE:index": define(`Hydraulic system pressure. Indexes start at 1.`, Pounds, Float64),
...
const PAYLOAD_STATIONS = {
  ...
  "PAYLOAD STATION NUM SIMOBJECTS:index": define(`The number of objects at the payload station.`, Number, Int32),
...
const YOKE = {
  ...
  "YOKE X POSITION": define(`Percent control deflection left/right (for animation).`, Position, SFloat64),
  ...
  "YOKE Y POSITION": define(`Percent control deflection fore/aft (for animation).`, Position, SFloat64),
