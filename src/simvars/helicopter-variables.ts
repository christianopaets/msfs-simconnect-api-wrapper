...
import { Bool, Degrees, Feet, Number, PercentOver100, Radians, Rankine, RPM } from "./units/index.js";
...
const ROTORS = {
  ...
  "ROTOR BRAKE ACTIVE": define(`Whether the rotor brake is active (1, TRUE) or not (0, FALSE).`, Bool, Int32),
  "ROTOR BRAKE HANDLE POS": define(`The percentage actuated of the rotor brake handle.`, PercentOver100, Float64),
  "ROTOR CHIP DETECTED": define(`Whether the rotor chip is detected (1,TRUE) or not (0, FALSE).`, Bool, Int32),
  "ROTOR CLUTCH ACTIVE": define(`Whether the rotor clutch is active (1, TRUE) or not (0, FALSE).`, Bool, Int32),
  "ROTOR CLUTCH SWITCH POS": define(
    `The rotor clutch switch position, either on (1 TRUE) or off (0, FALSE).`,
    Bool,
    Int32,
  ),
  "ROTOR COLLECTIVE BLADE PITCH PCT": define(`The rotor collective blade pitch.`, PercentOver100, Float64),
  "ROTOR CYCLIC BLADE MAX PITCH POSITION": define(
    `The position (angle) at which blade has the maximum cyclic pitch.`,
    Degrees,
    Float64,
  ),
  "ROTOR CYCLIC BLADE PITCH PCT": define(`The rotor cyclic blade (maximum) pitch.`, PercentOver100, Float64),
  "ROTOR GOV ACTIVE": define(`Whether the rotor governor is active (1, TRUE) or not (0, FALSE).`, Bool, Int32),
  ...
  "ROTOR LONGITUDINAL TRIM PCT": define(`The rotor longitudinal trim percentage.`, PercentOver100, Float64),
  ...
  //   ),
  "TAIL ROTOR BLADE PITCH PCT": define(`The pitch position of the tailrotor blades.`, PercentOver100, Float64),
  "TAIL ROTOR PEDAL POSITION": define(`Percent tail rotor pedal deflection.`, PercentOver100, Float64),
} as const;
