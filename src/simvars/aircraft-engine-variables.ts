...
export const AircraftEngineVariables = {
  ...
  "BLEED AIR SOURCE CONTROL:index": define(`The bleed air system source controller for an indexed engine`, Enum, Int32),
  ...
  "ENG ANTI ICE:index": define(`Anti-ice switch for the indexed engine, true if enabled false otherwise`, Bool, Int32),
  "ENG COMBUSTION:index": define(`True if the indexed engine is running, false otherwise`, Bool, Int32),
  "ENG CYLINDER HEAD TEMPERATURE:index": define(`The indexed engine cylinder head temperature`, Rankine, Float64),
  "ENG EXHAUST GAS TEMPERATURE:index": define(`Exhaust gas temperature for the indexed engine`, Rankine, Float64),
  ...
  "ENG FUEL FLOW PPH:index": define(`The indexed engine fuel flow in pounds per hour`, PoundsPerHour, Float64),
  ...
  "FULL THROTTLE THRUST TO WEIGHT RATIO": define(`Full throttle thrust to weight ratio`, Number, Int32),
  "GENERAL ENG ANTI ICE POSITION:index": define(`The indexed engine anti-ice switch state`, Bool, Int32),
  ...
  "GENERAL ENG DAMAGE PERCENT:index": define(`Percent of total damage to the indexed engine`, Percent, Float64),
  "GENERAL ENG ELAPSED TIME:index": define(`Total elapsed time since the indexed engine was started`, Hours, Float64),
  "GENERAL ENG EXHAUST GAS TEMPERATURE:index": define(`The indexed engine exhaust gas temperature`, Rankine, SFloat64),
  ...
  "GENERAL ENG MAX REACHED RPM:index": define(`Maximum attained rpm for the indexed engine`, RPM, Float64),
  ...
  "GENERAL ENG OIL TEMPERATURE:index": define(`The indexed engine oil temperature`, Rankine, SFloat64),
  "GENERAL ENG PCT MAX RPM:index": define(`Percent of max rated rpm for the indexed engine`, Percent, SFloat64),
  ...
  "GENERAL ENG STARTER ACTIVE:index": define(`True if the indexed engine starter is active`, Bool, Int32),
  ...
  "MASTER IGNITION SWITCH": define(`Aircraft master ignition switch (grounds all engines magnetos)`, Bool, Int32),
  "MAX EGT": define(
  ...
  "PANEL AUTO FEATHER SWITCH:index": define(`Auto-feather arming switch for the indexed engine`, Bool, Int32),
  "PROP AUTO CRUISE ACTIVE": define(`True if prop auto cruise active`, Bool, Int32),
  "PROP AUTO FEATHER ARMED:index": define(`Auto-feather armed state for the indexed engine`, Bool, Int32),
  ...
  "PROP DEICE SWITCH:index": define(`True if prop deice switch on for the indexed engine`, Bool, Int32),
  ...
  "PROP FEATHERING INHIBIT:index": define(`Feathering inhibit flag for the indexed engine`, Bool, Int32),
  "PROP FEATHER SWITCH:index": define(`Prop feather switch for the indexed engine`, Bool, Int32),
  "PROP MAX RPM PERCENT:index": define(`Percent of max rated rpm for the indexed engine`, Percent, SFloat64),
  ...
  "RECIP CARBURETOR TEMPERATURE:index": define(`Carburetor temperature the indexed engine`, Celsius, SFloat64),
  "RECIP ENG ALTERNATE AIR POSITION:index": define(`Alternate air control the indexed engine`, Position, SInt32),
  ...
  "RECIP ENG BRAKE POWER:index": define(`Brake power produced by the indexed engine`, Pounds, SFloat64),
  "RECIP ENG COOLANT RESERVOIR PERCENT:index": define(
    `Percent coolant available for the indexed engine`,
    Percent,
    SFloat64,
  ),
  "RECIP ENG COWL FLAP POSITION:index": define(`Percent cowl flap opened for the indexed engine`, Percent, SFloat64),
  ...
  "RECIP ENG DETONATING:index": define(`Set to 1 (TRUE) if the indexed engine is detonating`, Bool, Int32),
  ...
  "RECIP ENG FUEL AVAILABLE:index": define(`True if fuel is available for the indexed engine`, Bool, SInt32),
  ...
  "RECIP ENG LEFT MAGNETO:index": define(` Left magneto state for the indexed engine`, Bool, SInt32),
  "RECIP ENG MANIFOLD PRESSURE:index": define(`The indexed engine manifold pressure`, Pounds, SFloat64),
  "RECIP ENG NITROUS TANK MAX QUANTITY:index": define(
    `The maximum quantity of nitrous permitted per indexed engine`,
    Gallons,
    Float64,
  ),
  "RECIP ENG NITROUS TANK QUANTITY:index": define(`The quantity of nitrous per indexed engine`, Gallons, SFloat64),
  ...
  "RECIP ENG NUM CYLINDERS:index": define(`The number of cylinders for the indexed engine`, Number, Int32),
  ...
  "RECIP ENG RADIATOR TEMPERATURE:index": define(`The indexed engine radiator temperature`, Celsius, SFloat64),
  "RECIP ENG RIGHT MAGNETO:index": define(` The indexed engine right magneto state`, Bool, SInt32),
  "RECIP ENG STARTER TORQUE:index": define(`Torque produced by the indexed engine`, FootPound, SFloat64),
  ...
  "RECIP ENG TURBOCHARGER FAILED:index": define(`The indexed engine turbo failed state`, Bool, SInt32),
  ...
  "RECIP MIXTURE RATIO:index": define(`Fuel / Air mixture ratio for the indexed engine`, Ratio, SFloat64),
  ...
  "TURB ENG COMMANDED N1:index": define(` Effective commanded N1 for the indexed turbine engine`, Percent, SFloat64),
  "TURB ENG CONDITION LEVER POSITION:index": define(` See documentation`, Enum, SInt32),
  "TURB ENG CORRECTED FF:index": define(`Corrected fuel flow for the indexed engine`, PoundsPerHour, SFloat64),
  "TURB ENG CORRECTED N1:index": define(`The indexed turbine engine corrected N1`, Percent, SFloat64),
  "TURB ENG CORRECTED N2:index": define(`The indexed turbine engine corrected N2`, Percent, SFloat64),
  "TURB ENG FREE TURBINE TORQUE:index": define(
    `The amount of free torque for the indexed turbine engine`,
    FootPound,
    SFloat64,
  ),
  "TURB ENG FUEL AVAILABLE:index": define(`True if fuel is available for the indexed engine`, Bool, Int32),
  "TURB ENG FUEL EFFICIENCY LOSS:index": define(
    `This is used to control the fuel efficiency loss of the indexed engine`,
    Percent,
    SFloat64,
  ),
  "TURB ENG FUEL FLOW PPH:index": define(`The indexed engine fuel flow rate`, PoundsPerHour, Float64),
  ...
  "TURB ENG IGNITION SWITCH:index": define(`True if the the indexed turbine engine ignition switch is on`, Bool, Int32),
  ...
  "TURB ENG MAX TORQUE PERCENT:index": define(`Percent of max rated torque for the indexed engine`, Percent, SFloat64),
  "TURB ENG N1:index": define(`The indexed turbine engine N1 value`, Percent, SFloat64),
  "TURB ENG N1 LOSS:index": define(`This is used to control the N1 loss of the indexed engine`, Percent, SFloat64),
  "TURB ENG N2:index": define(` The indexed turbine engine N2 value`, Percent, SFloat64),
  "TURB ENG NUM TANKS USED:index": define(`Number of tanks currently being used by the indexed engine`, Number, Int32),
  ...
  "TURB MAX ITT": define(`Retrieve the itt_peak_temperature as set in the engine.cfg file`, Rankine, Float64),
} as const;
