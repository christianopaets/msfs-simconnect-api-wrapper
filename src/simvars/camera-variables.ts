...
import { Bool, Enum, NullUnit, Number, Percent, Radians } from "./units/index.js";
import { Float64, Int32, SFloat64, SInt32, StringV } from "./data-types/index.js";
...
const DRONE_CAMERAS = {
  ...
  "DRONE CAMERA FOLLOW": define(`Sets/gets the whether the drone camera is in follow mode or not.`, Bool, SInt32),
  "DRONE CAMERA FOV": define(
    `Sets/gets the zoom/FOV modifier for the drone camera. Default is 50%.`,
    Percent,
    SFloat64,
  ),
  "DRONE CAMERA LOCKED": define(`Sets/gets the whether the drone camera is locked or not.`, Bool, SInt32),
...
const SMART_CAMERAS = {
  "SMART CAMERA ACTIVE": define(`Sets/gets the whether the smart camera is active or not.`, Bool, SInt32),
