...
import { Bool, Enum, Gallons, GallonsPerHour, KiloPascal, Number, PercentOver100, Pounds } from "./units/index.js";
import { Float64, Int32, SFloat64 } from "./data-types/index.js";
...
const GENERAL = {
  ...
  "FUEL TOTAL CAPACITY": define(`Total fuel capacity of the aircraft for all tanks.`, Gallons, Float64),
  "FUEL TOTAL QUANTITY": define(
    `Current total quantity of fuel in volume for all tanks of the aircraft.`,
    Gallons,
    Float64,
  ),
  "FUEL TOTAL QUANTITY WEIGHT": define(`Current total fuel weight for all tanks of the aircraft`, Pounds, Float64),
  "FUEL TRANSFER PUMP ON:index": define(`Returns 1 (TRUE) if the indexed pump is active.`, Bool, Int32),
...
const FUEL_TANKS = {
  "FUEL TANK CENTER CAPACITY": define(`Maximum capacity in volume of center tank.`, Gallons, Float64),
  "FUEL TANK CENTER2 CAPACITY": define(`Maximum capacity in volume of center tank 2.`, Gallons, Float64),
  "FUEL TANK CENTER3 CAPACITY": define(`Maximum capacity in volume of center tank 3.`, Gallons, Float64),
  "FUEL TANK CENTER LEVEL": define(`Percent of maximum capacity of center tank.`, PercentOver100, SFloat64),
  "FUEL TANK CENTER2 LEVEL": define(`Percent of maximum capacity of center tank 2.`, PercentOver100, SFloat64),
  "FUEL TANK CENTER3 LEVEL": define(`Percent of maximum capacity of center tank 3.`, PercentOver100, SFloat64),
  "FUEL TANK CENTER QUANTITY": define(`Current quantity in volume of center tank.`, Gallons, SFloat64),
  "FUEL TANK CENTER2 QUANTITY": define(`Current quantity in volume of center tank 2.`, Gallons, SFloat64),
  "FUEL TANK CENTER3 QUANTITY": define(`Current quantity in volume of center tank 3.`, Gallons, SFloat64),
  "FUEL TANK EXTERNAL1 CAPACITY": define(`Maximum capacity in volume of external tank.`, Gallons, SFloat64),
  "FUEL TANK EXTERNAL2 CAPACITY": define(`Maximum capacity in volume of external tank 2.`, Gallons, SFloat64),
  "FUEL TANK EXTERNAL1 LEVEL": define(`Percent of maximum capacity of texternal tank.`, PercentOver100, SFloat64),
  "FUEL TANK EXTERNAL2 LEVEL": define(`Percent of maximum capacity of texternal tank 2.`, PercentOver100, SFloat64),
  "FUEL TANK EXTERNAL1 QUANTITY": define(`Current quantity in volume of external tank.`, Gallons, Float64),
  "FUEL TANK EXTERNAL2 QUANTITY": define(`Current quantity in volume of external tank 2.`, Gallons, Float64),
  "FUEL TANK LEFT AUX CAPACITY": define(`Maximum capacity in volume of the left auxiliary tank.`, Gallons, Float64),
  "FUEL TANK LEFT AUX LEVEL": define(
    `Percent of maximum capacity of the left auxiliary tank.`,
    PercentOver100,
    SFloat64,
  ),
  "FUEL TANK LEFT AUX QUANTITY": define(`Current quantity in volume of the left auxiliary tank.`, Gallons, SFloat64),
  "FUEL TANK LEFT MAIN CAPACITY": define(`Maximum capacity in volume of the left main tank.`, Gallons, Float64),
  "FUEL TANK LEFT MAIN LEVEL": define(`Percent of maximum capacity of the left main tank.`, PercentOver100, SFloat64),
  "FUEL TANK LEFT MAIN QUANTITY": define(`Current quantity in volume of the left main tank.`, Gallons, SFloat64),
  "FUEL TANK LEFT TIP CAPACITY": define(`Maximum capacity in volume of the left tip tank.`, Gallons, Float64),
  "FUEL TANK LEFT TIP LEVEL": define(`Percent of maximum capacity of the left tip tank.`, PercentOver100, SFloat64),
  "FUEL TANK LEFT TIP QUANTITY": define(`Current quantity in volume of the left tip tank.`, Gallons, SFloat64),
  "FUEL TANK RIGHT AUX CAPACITY": define(`Maximum capacity in volume of the right auxiliary tank.`, Gallons, Float64),
  "FUEL TANK RIGHT AUX LEVEL": define(
    `Percent of maximum capacity of the right auxiliary tank.`,
    PercentOver100,
    SFloat64,
  ),
  "FUEL TANK RIGHT AUX QUANTITY": define(`Current quantity in volume of the right auxiliary tank.`, Gallons, SFloat64),
  "FUEL TANK RIGHT MAIN CAPACITY": define(`Maximum capacity in volume of the right main tank.`, Gallons, Float64),
  "FUEL TANK RIGHT MAIN LEVEL": define(`Percent of maximum capacity of the right main tank.`, PercentOver100, SFloat64),
  "FUEL TANK RIGHT MAIN QUANTITY": define(`Current quantity in volume of the right main tank.`, Gallons, SFloat64),
  "FUEL TANK RIGHT TIP CAPACITY": define(`Maximum capacity in volume of the right tip tank.`, Gallons, Float64),
  "FUEL TANK RIGHT TIP LEVEL": define(`Percent of maximum capacity of the right tip tank.`, PercentOver100, SFloat64),
  "FUEL TANK RIGHT TIP QUANTITY": define(`Current quantity in volume of the right tip tank.`, Gallons, SFloat64),
