import { Bool, Degrees, Enum, Feet, Knots, NullUnit, Number, Percent, PercentOver100, Radians } from "./units/index.js";
import { define } from "./definition/define.js";
import { Float64, Int32, SFloat64, SInt32, String256, String32 } from "./data-types/index.js";

const AUTOPILOT = {
  "AUTOPILOT AIRSPEED ACQUISITION": define(`Currently not used within the simulation`, Bool, Int32),
  "AUTOPILOT AIRSPEED HOLD": define(`returns whether airspeed hold is active (1, TRUE) or not (0, FALSE)`, Bool, Int32),
  "AUTOPILOT AIRSPEED HOLD CURRENT": define(`Currently not used within the simulation`, Bool, Int32),
  "AUTOPILOT AIRSPEED HOLD VAR": define(`Returns the target holding airspeed for the autopilot`, Knots, Float64),
  ...
  "AUTOPILOT APPROACH HOLD": define(`Returns whether pproach mode is active (1, TRUE) or not (0, FALSE)`, Bool, Int32),
  "AUTOPILOT APPROACH IS LOCALIZER": define(`Returns true if the current approach is using a localizer`, Bool, Int32),
  ...
  "AUTOPILOT FLIGHT LEVEL CHANGE": define(`Boolean, toggles the autopilot Flight Level Change mode`, Bool, SInt32),
  ...
  "AUTOPILOT GLIDESLOPE ARM": define(`Returns true when the autopilot is active on the glide slope`, Bool, Int32),
  ...
  "AUTOPILOT MACH HOLD VAR": define(`Returns the target holding mach airspeed for the autopilot`, Number, Int32),
  ...
  "AUTOPILOT MAX BANK": define(`Returns the maximum banking angle for the autopilot, in radians.`, Radians, Float64),
  ...
  "AUTOPILOT PITCH HOLD": define(`Set to True if the autopilot pitch hold has is engaged`, Bool, Int32),
  "AUTOPILOT PITCH HOLD REF": define(`Returns the current autotpilot reference pitch.`, Radians, Float64),
...
const AIRCRAFT_ASSISTANCE = {
  "ASSISTANCE LANDING ENABLED": define(`Returns whether landing assistance has been enabled or not`, Bool, Int32),
  "ASSISTANCE TAKEOFF ENABLED": define(`Returns whether takeoff assistance has been enabled or not`, Bool, Int32),
} as const;

const AI_AIRCRAFT_PILOT = {
  "AI ANTISTALL STATE": define(`The current state of the AI anti-stall system`, Enum, Int32),
  "AI AUTOTRIM ACTIVE": define(`Returns whether the AI auto-trim system is enabled or not`, Bool, Int32),
  ...
  "AI CURSOR MODE ACTIVE": define(`Returns whether the AI cursor mode is active or not`, Bool, Int32),
  ...
  "DELEGATE CONTROLS TO AI": define(`Returns whether the AI control system is active or not`, Bool, SInt32),
} as const;
...
const FLIGHT_ASSISTANT = {
  ...
  "FLY ASSISTANT NEAREST SELECTED": define(`Returns the index of the currently selected element`, Number, SInt32),
  ...
  "FLY ASSISTANT TAKEOFF SPEED": define(`Returns the flight assistant takeoff speed`, Knots, SFloat64),
