...
import { Float64, Int32 } from "./data-types/index.js";
...
const JETWAY = {
  ...
  "JETWAY WHEEL ORIENTATION CURRENT": define(`The current angle of the jetway wheels.`, Degrees, Float64),
  "JETWAY WHEEL ORIENTATION TARGET": define(`The (approximate) target angle for the jetway wheels.`, Degrees, Float64),
  "JETWAY WHEEL SPEED": define(`The current speed of the jetway wheels.`, MetersPerSecond, Float64),
} as const;

const MARSHALLER = {
  "MARSHALLER AIRCRAFT DIRECTION PARKINGSPACE": define(`Currently not used in the simulation.`, Degrees, Float64),
  "MARSHALLER AIRCRAFT DISTANCE": define(`The distance between the Marshaller and the aircraft.`, Meters, Float64),
...
const PUSHBACK = {
  ...
  "PUSHBACK AVAILABLE": define(`True if a push back is available on the parking space.`, Bool, Int32),
  "PUSHBACK CONTACTX": define(`The towpoint position, relative to the aircrafts datum reference point.`, Feet, Float64),
