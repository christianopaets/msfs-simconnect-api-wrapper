...
const ATC = {
  ...
  "ATC AIRPORT IS TOWERED": define(`If the airport is controlled, this boolean is true.`, Bool, Int32),
  ...
  "ATC ID": define(`ID used by ATC, as a string with a maximum number of 10 characters.`, NullUnit, SString32),
  ...
  "ATC MODEL": define(`Model used by ATC, as a string with a maximum number of 10 characters.`, NullUnit, String32),
  ...
  "ATC SUGGESTED MIN RWY LANDING": define(`Suggested minimum runway length for landing. Used by ATC.`, Feet, Float64),
  "ATC SUGGESTED MIN RWY TAKEOFF": define(`Suggested minimum runway length for takeoff. Used by ATC.`, Feet, Float64),
...
const COM = {
  ...
  "COM SPACING MODE:index": define(`The COM radio frequency step. Index is 1, 2 or 3.`, Enum, Int32),
  ...
  "COM STATUS:index": define(`Radio status flag for the indexed com channel. Index is 1, 2 or 3.`, Enum, Int32),
...
const FLARM = {
  "FLARM AVAILABLE": define(`Whether the FLARM is available (TRUE, 1) or not (FALSE, 0).`, Bool, SInt32),
  "FLARM THREAT BEARING": define(`The bearing of the FLARM threat aircraft, relative to track.`, Degrees, Float64),
  ...
  "FLARM THREAT RELATIVE ALTITUDE": define(`The relative altitude of the threat object.`, Meters, Float64),
  "FLARM THREAT TIME TO COLLISION": define(`The estimated time to a collision.`, Seconds, Float64),
  "FLARM THREAT VERTICAL BEARING": define(`The vertical bearing towards the threat.`, Degrees, Float64),
} as const;
...
const GPS = {
  ...
  "GPS OBS VALUE": define(`This is the currently selected OBS course in degrees, from 0 to 360.`, Degrees, SFloat64),
  ...
  "GPS VERTICAL ANGLE ERROR": define(`Vertical error in degrees from GlidePath.`, Degrees, SFloat64),
...
const HSI = {
  ...
  "HSI BEARING VALID": define(`This will return true if the HSI BEARING variable contains valid data.`, Bool, Int32),
...
const MARKERS = {
  ...
  "MARKER BEACON TEST MUTE": define(`Whether or not the Marker Beacon is in Test/Mute mode.`, Bool, Int32),
...
const NAV = {
  ...
  "NAV GLIDE SLOPE LENGTH": define(`The distance between the plane and the Glide beacon.`, Feet, Float64),
  "NAV GSI": define(
  ...
  "NAV RADIAL ERROR": define(`Difference between current radial and OBS tuned radial.`, Degrees, Float64),
  ...
  "NAV TOFROM": define(`Returns whether the Nav is going to or from the current radial (or is off).`, Enum, Int32),
...
const TACAN = {
  ...
  "TACAN STATION IDENT:index": define(`The tuned station identifier for the indexed Tacan.`, NullUnit, String32),
  // "TACAN STATION LATLONALT:index": define(
  //   `Retrieves the latitude, longitude and altitude of the Tacan station.`,
  //   units: `struct`,
  //   ...dataType(`LatLonAlt`),
  // },
  "TACAN STATION RADIAL:index": define(`The radial between the Tacan station and the aircraft.`, Degrees, Float64),
