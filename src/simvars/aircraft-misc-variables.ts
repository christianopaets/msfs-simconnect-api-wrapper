...
import { Float64, Int32, SFloat64, SInt32, String128 } from "./data-types/index.js";
...
const AIRCRAFT_STATES = {
  ...
  "PLANE IN PARKING STATE": define(`Whether or not the plane is currently parked (true) or not (false)`, Bool, Int32),
  "SURFACE CONDITION": define(`The state of the surface directly under the aircraft`, Enum, Int32),
  "SURFACE INFO VALID": define(`True indicates that the SURFACE CONDITION return value is meaningful`, Bool, Int32),
  "SURFACE TYPE": define(`The type of surface under the aircraft`, Enum, Int32),
  "STRUCTURAL ICE PCT": define(`Amount of ice on aircraft structure. 100 is fully iced`, PercentOver100, Float64),
  TITLE: define(`Title from aircraft.cfg`, NullUnit, String128),
  "TOW CONNECTION": define(`True if a towline is connected to both tow plane and glider`, Bool, Int32),
  "WINDSHIELD RAIN EFFECT AVAILABLE": define(`Is visual effect available on this aircraft`, Bool, Int32),
} as const;

const AIRCRAFT_POSITION_DIRECTION_AND_SPEED = {
  "ACCELERATION BODY X": define(`Acceleration relative to aircraft X axis, in east/west direction`, Feet, Float64),
  "ACCELERATION BODY Y": define(`Acceleration relative to aircraft Y axis, in vertical direction`, Feet, Float64),
  "ACCELERATION BODY Z": define(`Acceleration relative to aircraft Z axis, in north/south direction`, Feet, Float64),
  "ACCELERATION WORLD X": define(`Acceleration relative to the earth X axis, in east/west direction`, Feet, Float64),
  "ACCELERATION WORLD Y": define(`Acceleration relative to the earth Y axis, in vertical direction`, Feet, Float64),
  "ACCELERATION WORLD Z": define(`Acceleration relative to the earth Z axis, in north/south direction`, Feet, Float64),
  ...
  "PLANE HEADING DEGREES GYRO": define(`Heading indicator taken from the aircraft gyro`, Degrees, SFloat64),
  ...
  "PLANE LATITUDE": define(`Latitude of aircraft, North is positive, South negative`, Radians, SFloat64),
  "PLANE LONGITUDE": define(`Longitude of aircraft, East is positive, West negative`, Radians, SFloat64),
  ...
  "RELATIVE WIND VELOCITY BODY Y": define(`Vertical (Y axis) speed relative to wind`, Feet, Float64),
  "RELATIVE WIND VELOCITY BODY Z": define(`Longitudinal (Z axis) speed relative to wind`, Feet, Float64),
  ...
  "ROTATION VELOCITY BODY X": define(`Rotation velocity relative to aircraft X axis`, Feet, SFloat64),
  "ROTATION VELOCITY BODY Y": define(`Rotation velocity relative to aircraft Y axis`, Feet, SFloat64),
  "ROTATION VELOCITY BODY Z": define(`Rotation velocity relative to aircraft Z axis`, Feet, SFloat64),
...
const TEMPERATURE = {
  "STANDARD ATM TEMPERATURE": define(`Outside temperature on the standard ATM scale`, Rankine, Float64),
