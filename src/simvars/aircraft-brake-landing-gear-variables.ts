...
const BRAKES = {
  ...
  "BRAKE DEPENDENT HYDRAULIC PRESSURE": define(`Brake dependent hydraulic pressure reading`, Pounds, Float64),
  ...
  "BRAKE LEFT POSITION EX1": define(`Percent left brake, ignoring the effect of the parking brake`, Position, SFloat64),
  "BRAKE PARKING INDICATOR": define(`Parking brake indicator`, Bool, Int32),
  "BRAKE PARKING POSITION": define(`Gets the parking brake position - either on (true) or off (false)`, Bool, Int32),
...
const LANDING_GEAR = {
  ...
  "GEAR ANIMATION POSITION:index": define(`Percent indexed gear animation extended`, Percent, Float64),
  ...
  "GEAR CENTER STEER ANGLE PCT": define(`Center steer angle as a percentage`, PercentOver100, Float64),
  ...
  "GEAR LEFT STEER ANGLE": define(`Left wheel angle, negative to the left, positive to the right`, Radians, Float64),
  ...
  "GEAR RIGHT STEER ANGLE": define(`Right wheel angle, negative to the left, positive to the right`, Radians, Float64),
  "GEAR RIGHT STEER ANGLE PCT": define(`Right steer angle as a percentage`, PercentOver100, Float64),
  "GEAR SPEED EXCEEDED": define(`True if safe speed limit for gear exceeded`, Bool, Int32),
  "GEAR STEER ANGLE:index": define(`Alternative method of getting the steer angle`, Radians, Float64),
  ...
  "GEAR WARNING:index": define(`Gear warnings`, Enum, Int32),
  ...
  "WATER LEFT RUDDER STEER ANGLE PCT": define(`Water left rudder angle as a percentage`, PercentOver100, Float64),
  ...
  "WATER RIGHT RUDDER STEER ANGLE PCT": define(`Water right rudder as a percentage`, PercentOver100, Float64),
