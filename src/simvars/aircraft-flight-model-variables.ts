...
const GENERAL = {
  ...
  "SEMIBODY LOADFACTOR YDOT": define(`Derivative of SEMIBODY LOADFACTOR Y in relation to time.`, Number, Float64),
  ...
  "STATIC PITCH": define(`The angle at which static pitch stability is achieved.`, Radians, Float64),
  "TYPICAL DESCENT RATE": define(`the typical (normal) descent rate for the aircraft.`, Feet, Float64),
  ...
  "ZERO LIFT ALPHA": define(`The angle of attack at which the wing has zero lift.`, Radians, Float64),
} as const;

const CENTER_OF_GRAVITY = {
  "CG AFT LIMIT": define(`Most backward authorized position of the CG according to the POH.`, PercentOver100, Float64),
  "CG FEET": define(`The longitudinal CG position relative to the Reference Datum Position.`, Feet, Float64),
  "CG FEET AFT LIMIT": define(`The aft CG limit position relative to the Reference Datum Position.`, Feet, Float64),
  "CG FEET LATERAL": define(`The lateral CG position relative to the Reference Datum Position.`, Feet, Float64),
  ...
  "CG FEET FWD LIMIT": define(`The forward CG limit position relative to the Reference Datum Position.`, Feet, Float64),
  "CG FWD LIMIT": define(`Most forward authorized position of the CG according to the POH.`, PercentOver100, Float64),
  "CG MAX MACH": define(`Deprecated, do not use!`, Mach, Float64),
  "CG MIN MACH": define(`Deprecated, do not use!`, Mach, Float64),
  "CG PERCENT": define(`Longitudinal CG position as a percent of reference chord`, PercentOver100, Float64),
  "CG PERCENT LATERAL": define(`Lateral CG position as a percent of reference chord`, PercentOver100, Float64),
...
const INTERACTIVE_POINTS = {
  ...
  "INTERACTIVE POINT POSX": define(`Interactive Point X position relative to datum reference point`, Feet, Float64),
  "INTERACTIVE POINT POSY": define(`Interactive Point Y position relative to datum reference point`, Feet, Float64),
  "INTERACTIVE POINT POSZ": define(`Interactive Point Z position relative to datum reference point`, Feet, Float64),
...
const WEIGHT = {
  ...
  "EMPTY WEIGHT CROSS COUPLED MOI": define(`Empty weight cross coupled moment of inertia`, Slugs, Float64),
  ...
  "TOTAL WEIGHT CROSS COUPLED MOI": define(`Total weight cross coupled moment of inertia`, Slugs, Float64),
